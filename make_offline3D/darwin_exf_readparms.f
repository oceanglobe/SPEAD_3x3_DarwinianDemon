...
C-- CPP flags controlling which code is included in the files that will be compiled.
...
C PAR forcing parameters for exf
     ...
     &    darwin_inscal_PAR
      ...
      Real*8 PARRepCycle
      Real*8 PARconst
      Real*8 PAR_exfremo_intercept
      Real*8 PAR_exfremo_slope
      Real*8 darwin_inscal_PAR


C iron forcing parameters for exf

      Real*8 ironStartTime
     ...
     &    darwin_inscal_iron
      ...
      Real*8 ironRepCycle
      Real*8 ironconst
      Real*8 iron_exfremo_intercept
      Real*8 iron_exfremo_slope
      Real*8 darwin_inscal_iron
...
C ice forcing parameters for exf
     ...
     &    darwin_inscal_ice
      ...
      Real*8 iceRepCycle
      Real*8 iceconst
      Real*8 ice_exfremo_intercept
      Real*8 ice_exfremo_slope
      Real*8 darwin_inscal_ice


C wind forcing parameters for exf

      Real*8 windStartTime
     ...
     &    darwin_inscal_wind
      ...
      Real*8 windRepCycle
      Real*8 windconst
      Real*8 wind_exfremo_intercept
      Real*8 wind_exfremo_slope
      Real*8 darwin_inscal_wind


C pCO2 forcing parameters for exf

      Real*8 pCO2StartTime
     ...
     &    darwin_inscal_pCO2
      ...
      Real*8 pCO2RepCycle
      Real*8 pCO2const
      Real*8 pCO2_exfremo_intercept
      Real*8 pCO2_exfremo_slope
      Real*8 darwin_inscal_pCO2
...
C Open and read the data.darwin file
      ...
      PARstartdate2         = 0
      PARconst              = UNSET_RL
      PAR_exfremo_intercept = 0.0D0
      PAR_exfremo_slope     = 0.0D0
      PARmask = 'c'

      darwin_inscal_PAR    =  1.D0
      ...
      ironstartdate2         = 0
      ironconst              = 0.0D0
      iron_exfremo_intercept = 0.0D0
      iron_exfremo_slope     = 0.0D0
      ironmask = 'c'

      darwin_inscal_iron    =  1.D0
      ...
      icestartdate2         = 0
      iceconst              = UNSET_RL
      ice_exfremo_intercept = 0.0D0
      ice_exfremo_slope     = 0.0D0
      icemask = 'c'

      darwin_inscal_ice    =  1.D0
      ...
      windstartdate2         = 0
      windconst              = UNSET_RL
      wind_exfremo_intercept = 0.0D0
      wind_exfremo_slope     = 0.0D0
      windmask = 'c'

      darwin_inscal_wind    =  1.D0
      ...
      pCO2startdate2         = 0
      pCO2const              = UNSET_RL
      pCO2_exfremo_intercept = 0.0D0
      pCO2_exfremo_slope     = 0.0D0
      pCO2mask = 'c'

      darwin_inscal_pCO2    =  1.D0
