...
C     GM_K3D_maxRenorm:: maximum value for the renormalisation factor
      ...
      Real*8 GM_K3D_gamma
      Real*8 GM_K3D_b1
      Real*8 GM_K3D_EadyMinDepth
      Real*8 GM_K3D_EadyMaxDepth
      Real*8 GM_K3D_Lambda
      Real*8 GM_K3D_smallK
      Real*8 GM_K3D_maxC
      Real*8 GM_maxK3D
      Real*8 GM_K3D_constK
      Real*8 GM_K3D_Rmax
      Real*8 GM_K3D_Rmin
      Real*8 GM_K3D_minCori
      Real*8 GM_K3D_minN2
      Real*8 GM_K3D_surfMinDepth
      Real*8 GM_K3D_vecFreq
      Real*8 GM_K3D_minRenorm
      Real*8 GM_K3D_maxRenorm
      Real*8 GM_facTrL2dz
      Real*8 GM_facTrL2ML
...
c    &       ConvectCount, ICEM,
     &       offline_Wght
c     Real*8 ICEM(1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
c     Real*8 ConvectCount(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8 offline_Wght(2,nSx,nSy)
...
c     Real*8  hflx0    (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
c     Real*8  hflx1    (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
c     Real*8  icem0    (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
c     Real*8  icem1    (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
...
c       CALL EXCH_XY_RS ( hflx0 ,  myThid  )
c       CALL EXCH_XY_RS ( hflx1 ,  myThid  )
c      ENDIF
...
c       CALL EXCH_XY_RS ( icem0,  myThid  )
c       CALL EXCH_XY_RS ( icem1,  myThid  )
c      ENDIF
...
C     (as it is the case when using Non-Lin Free-Surf)
     ...
     &                         + aWght*uvel1(i,j,k,bi,bj))*scalingVel
             vVel(i,j,k,bi,bj) =(bWght*vvel0(i,j,k,bi,bj)
     &                         + aWght*vvel1(i,j,k,bi,bj))*scalingVel
             wVel(i,j,k,bi,bj) =(bWght*wvel0(i,j,k,bi,bj)
     &                         + aWght*wvel1(i,j,k,bi,bj))*scalingVel
