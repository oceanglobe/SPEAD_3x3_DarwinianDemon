...
c carbon budget
          ...
          DO np=1,nplank
C Continuous model: only the first moment (total biomass) of each species
C is involved in mass conservation (Le Gland, 18/03/2021)
C           iTr=ic+np-1
            iTr=ic+iplank(np)-1
...
c oxygem budget !!!!!!!! NOT FULL BUDGET !!!!!!!!!!!
      ...
      CALL GLOBAL_SUM_R8 ( tmptotC, myThid )
      CALL GLOBAL_SUM_R8 ( tmptotP, myThid )
      CALL GLOBAL_SUM_R8 ( tmptotN, myThid )
      CALL GLOBAL_SUM_R8 ( tmptotFe, myThid )
      CALL GLOBAL_SUM_R8 ( tmptotSi, myThid )
      CALL GLOBAL_SUM_R8 ( voltot, myThid )
      CALL GLOBAL_SUM_R8 ( tmptotA, myThid )
      CALL GLOBAL_SUM_R8 ( tmptotO, myThid )
      CALL GLOBAL_SUM_R8 ( tmptotNfix, myThid )
      CALL GLOBAL_SUM_R8 ( tmptotNdenit, myThid )
