...
C Le Gland, 10/12/2020
     ...
     &    a_kgrazesat,
     &    b_kgrazesat,
C Allometric palatability (Le Gland, 10/06/2021)
     &    a_palat,
     &    b_palat,
     &    a_biosink,
     &    a_biosink_denom,
     ...
     &    a_PCmax_denom,
     &    b_PCmax,
C Unimodal distribution (Le Gland, 10/06/2021)
C    &    b1_PCmax,
C    &    b2_PCmax,
C    &    c_PCmax,
     &    a_qcarbon,
...
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
      ...
      val_amminhib = 4.6D0
      val_ksatsio2 = 1.D0
      smallksatpar = 0.12D-1
      smallksatparstd = 0.20D-1
      smallkinhpar = 6.0D-3
      smallkinhparstd = 0.10D-3
      Bigksatpar = 0.12D-1
      Bigksatparstd = 0.06D-1
      Bigkinhpar = 1.0D-3
      Bigkinhparstd = 0.05D-3
      LLProkinhpar = 6.0D-3
      Coccokinhpar = 0.5D-3
      inhibcoef_geid_val = 0D0
      smallmQyield = 5.D-5
      smallmQyieldrange = 1.D-4
      BigmQyield = 3.D-5
      BigmQyieldrange = 4.D-5
      smallchl2cmax = 0.2D0
      smallchl2cmaxrange = 0.3D0
      Bigchl2cmax = 0.5D0
      Bigchl2cmaxrange = 0.3D0
      aphy_chl_ave = 0.02D0
      val_acclimtimescl = 1./(60.D0*60.D0*24.D0*20.D0)
      oldTwoGrazers = .FALSE.
      ...
      GrazeEffmod = 0.5D0
      GrazeEffhi = 0.7D0
      GrazeRate = 1.0D0/(2.0D0*pday)
      ExGrazfrac = 0.8D0
      val_palat = 0.0D0
      val_ass_eff = 0.70D0
      kgrazesat_val = 12D0
      Zoomort = 1.0D0/(30.0D0*pday)
      Zoomort2 = 0.D0
      Zooexfac = 0.7D0
      ZooDM = 100D0
...
C     used to be 120D-20 for phyto
      a_Xmin = 0D0
      a_R_NC = 16.0D0/120.0D0
      a_R_PC = 1D0/120.0D0
      a_R_SiC = 0D0
      a_R_FeC = 1.0D-3/120.0D0
      a_R_ChlC = 16D0/120D0
      a_R_PICPOC = 0.8D0
      a_ExportFracMort = 0.5D0
      a_ExportFracMort2 = 0.5D0
      a_ExportFracExude = DARWIN_UNINIT_RL
      a_mort = 0.02D0 / pday
      a_mort2 = 0.0D0
      a_phytoTempCoeff = 1.D0/3.D0
      a_phytoTempExp2 = 0.001D0
      a_phytoTempExp1 = 1.04D0
C     a_phytoTempOptimum = 2.D0
C Le Gland, 10/12/2020
      a_phytoTempTol = 5.D0
      a_phytoDecayPower = 4.D0
      a_ksatPAR = 0.012D0
      a_kinhPAR = 6.0D-3
      a_amminhib = 4.6D0
      a_acclimtimescl = 1D0/(20*pday)
      a_acclimtimescl_denom = 1D0
      a_ksatPON = 1D0
      a_ksatDON = 1D0
      a_grazemax = 21.9D0 / pday
      a_grazemax_denom = 1.D0
      b_grazemax = -0.16D0
C     used to be 22.4
      a_kgrazesat = 1.00D0
      b_kgrazesat = 0.00D0
C Allometric palatability (Le Gland, 10/06/2021)
      a_palat = 0.00D0
      b_palat = 0.00D0
      a_biosink = 0.28D-1 / pday
      a_biosink_denom = 1.D0
      b_biosink = 0.39D0
      a_bioswim = 0.00D0 / pday
...
C     was 3.21D-11 / pday
      a_respRate_c = 0.00D0
      a_respRate_c_denom = 1.D0
      b_respRate_c = 0.93D0
C     was 0.32D-1 / pday
      a_kexcC = 0.00D0
      b_kexcC = -0.33D0
      a_vmaxNO3 = 0.51D0 / pday
      a_vmaxNO3_denom = 1.D0
      b_vmaxNO3 = -0.27D0
      a_ksatNO3 = 0.17D0
      b_ksatNO3 = 0.27D0
      a_Qnmin = 0.07D0
...
C     was 0.24D-1 / pday
      a_kexcN = 0.00D0
      b_kexcN = -0.33D0
      a_vmaxNO2 = 0.51D0 / pday
      a_vmaxNO2_denom = 1.0D0
      b_vmaxNO2 = -0.27D0
      a_ksatNO2 = 0.17D0
      b_ksatNO2 = 0.27D0
      a_ksatNO2fac = 1.0D0
      a_vmaxNH4 = 0.26D0 / pday
      a_vmaxNH4_denom = 1.0D0
      b_vmaxNH4 = -0.27D0
      a_ksatNH4 = 0.85D-1
      b_ksatNH4 = 0.27D0
      a_ksatNH4fac = 0.5D0
      ...
      a_vmaxN_denom = 1.D0
      b_vmaxN = -0.27D0
      a_vmaxPO4 = 0.77D-1 / pday
      a_vmaxPO4_denom = 1.0D0
      b_vmaxPO4 = -0.27D0
      a_ksatPO4 = 0.26D-1
      b_ksatPO4 = 0.27D0
      a_Qpmin = 2.00D-3
      ...
      a_Qpmax = 0.01D0
      b_Qpmax = 0.00D0
      a_kexcP = 0.24D-1 / pday
      b_kexcP = -0.33D0
      a_vmaxSiO2 = 0.77D-1 / pday
      a_vmaxSiO2_denom = 1.0D0
      b_vmaxSiO2 = -0.27D0
      a_ksatSiO2 = 0.24D-1
      b_ksatSiO2 = 0.27D0
C     was 0.084
...
C     was -0.13
      b_Qsimax = 0.00D0
      a_kexcSi = 0.00D0  / pday
      b_kexcSi = 0.00D0
C     was 96.2D-6 / pday
      a_vmaxFeT = 14.0D-6 / pday
      a_vmaxFeT_denom = 1.0D0
      b_vmaxFeT = -0.27D0
C     was 32.1D-6
      a_ksatFeT = 80.0D-6
      b_ksatFeT = 0.27D0
