...
C     bbphy_mgC   :: [m^-1 (mg C m^-3)^-1]    carbon-specific backscattering coefficient
     ...
     &    bphy_mgC,
     &    bbphy_mgC
C     _RL aphy_chl(nplank,nlam)
C     _RL aphy_chl_ps(nplank,nlam)
C     _RL bphy_mgC(nplank,nlam)
C     _RL bbphy_mgC(nplank,nlam)
C nplank replaced by nTrac for consistence withh the rest of the code (Le Gland, 16/03/2021)
      _RL aphy_chl(nTrac,nlam)
      _RL aphy_chl_ps(nTrac,nlam)
      _RL bphy_mgC(nTrac,nlam)
      _RL bbphy_mgC(nTrac,nlam)

#endif /* ALLOW_RADTRANS */

      COMMON /DARWIN_RT_DEPTRAITS_r/
     &    alphachl
C     _RL alphachl(nplank,nlam)
C nplank replaced by nTrac for consistence withh the rest of the code (Le Gland, 16/03/2021)
      _RL alphachl(nTrac,nlam)
