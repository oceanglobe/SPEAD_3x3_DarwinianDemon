...
C     _RL logvolinc
      _RL biovol0(nGroup)
C     _RL biovolfac(nGroup)
      _RL Topt0(nGroup)
C     _RL Toptfac(nGroup)
C     _RL grp_logvolind(nPlank,nGroup)
C     _RL grp_biovol(nPlank,nGroup)
C     _RL grp_Topt(nPlank,nGroup)
C Light-related traits (Le Gland, 30/03/2021)
      _RL PARopt0(nGroup)
      _RL PARchi0(nGroup)
C Le Gland, 18/12/2020
...
C     _RL numut_bvol(nplank)
C     _RL numut_topt(nplank)
C Le Gland, 25/03/2021
...
C Palatability allometry (Le Gland, 10/06/2021)
      ...
      _RL b_PCmax(nGroup)
C Unimodal growth rate (Le Gland, 10/06/2021)
C     _RL b1_PCmax(nGroup)
C     _RL b2_PCmax(nGroup)
C     _RL c_PCmax(nGroup)
